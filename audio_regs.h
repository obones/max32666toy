...
/**
 * @ingroup  audio_registers PDM_TX_RATE_SETUP
 * @defgroup PDM_TX_RATE_SETUP PDM_TX_RATE_SETUP
 * @brief    PDM Tx Rate Setup Register
 * @{
 */
#define PDM_TX_CLK_RATE_POS 0  /**< PDM_TX_CLK_RATE position */
#define PDM_TX_CLK_RATE_MCLK_DIV_8 \
        ((uint32_t)(0x00UL << PDM_TX_CLK_RATE_POS))
#define PDM_TX_CLK_RATE_MCLK_DIV_4 \
        ((uint32_t)(0x01UL << PDM_TX_CLK_RATE_POS))
#define PDM_TX_CLK_RATE_MCLK_DIV_2 \
        ((uint32_t)(0x02UL << PDM_TX_CLK_RATE_POS))
#define PDM_TX_CLK_RATE_MCLK \
        ((uint32_t)(0x03UL << PDM_TX_CLK_RATE_POS))

#define PDM_TX_CLK_DATA_SR 2  /**< PDM_TX_CLK_DATA_SR position */
#define PDM_TX_CLK_DATA_SR_PDM_TX_CLK_DIV_8 \
        ((uint32_t)(0x00UL << PDM_TX_CLK_DATA_SR))
#define PDM_TX_CLK_DATA_SR_PDM_TX_CLK_DIV_4 \
        ((uint32_t)(0x01UL << PDM_TX_CLK_DATA_SR))
#define PDM_TX_CLK_DATA_SR_PDM_TX_CLK_DIV_2 \
        ((uint32_t)(0x02UL << PDM_TX_CLK_DATA_SR))
#define PDM_TX_CLK_DATA_SR_PDM_TX_CLK \
        ((uint32_t)(0x03UL << PDM_TX_CLK_DATA_SR))

/**@} end of group PDM_TX_RATE_SETUP */
...
/**
 * @ingroup  audio_registers
 * @defgroup PDM_TX_CONTROL_1 PDM_TX_CONTROL_1
 * @brief    PDM Tx Configuration 0
 * @{
 */
#define PDM_TX_2_CH1_HIZ_POS 7
#define PDM_TX_2_CH1_HIZ \
        ((uint32_t)(0x01UL << PDM_TX_2_CH1_HIZ_POS))

#define PDM_TX_2_CH0_HIZ_POS 6
#define PDM_TX_2_CH0_HIZ \
        ((uint32_t)(0x01UL << PDM_TX_2_CH0_HIZ_POS))

#define PDM_TX_2_CH1_EN_POS 5
#define PDM_TX_2_CH1_EN \
        ((uint32_t)(0x01UL << PDM_TX_2_CH1_EN_POS))

#define PDM_TX_2_CH0_POS 4
#define PDM_TX_2_CH0_EN \
        ((uint32_t)(0x01UL << PDM_TX_2_CH0_EN_POS))

#define PDM_TX_1_CH1_HIZ_POS 3
#define PDM_TX_1_CH1_HIZ \
        ((uint32_t)(0x01UL << PDM_TX_1_CH1_HIZ_POS))

#define PDM_TX_1_CH0_HIZ_POS 2
#define PDM_TX_1_CH0_HIZ \
        ((uint32_t)(0x01UL << PDM_TX_1_CH0_HIZ_POS))

#define PDM_TX_1_CH1_EN_POS 1
#define PDM_TX_1_CH1_EN \
        ((uint32_t)(0x01UL << PDM_TX_1_CH1_EN_POS))

#define PDM_TX_1_CH0_EN_POS 0
#define PDM_TX_1_CH0_EN \
        ((uint32_t)(0x01UL << PDM_TX_1_CH0_EN_POS))

/**@} end of group PDM_TX_CONTROL_1 */

/**
 * @ingroup  audio_registers
 * @defgroup PDM_TX_CONTROL_2 PDM_TX_CONTROL_2
 * @brief    PDM Tx Configuration 1
 * @{
 */
#define PDM_TX_EDGE_SEL_POS 1
#define PDM_TX_EDGE_SEL_RISING \
        ((uint32_t)(0x01UL << PDM_TX_EDGE_SEL_POS))

#define PDM_TX_MODE_POS 0
#define PDM_TX_MODE_1_5_BIT \
        ((uint32_t)(0x01UL << PDM_TX_MODE_POS))

/**@} end of group PDM_TX_CONTROL_2 */
...
#define MXC_F_PCM_FORMATX_PCM_RIGHT \
